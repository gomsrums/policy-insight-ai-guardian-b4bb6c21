...
const DocumentPreview = ({ document, onRemove }: DocumentPreviewProps) => {
  const renderPreview = () => {
    ...
    return (
      <div className="h-32 w-full bg-gray-100 p-2 overflow-hidden rounded">
        <p className="text-xs line-clamp-6">
          {document.content ? document.content.substring(0, 200) + "..." : "Text document"}
        </p>
      </div>
    );
  };
  ...
  return (
    <div className="relative group border rounded-md p-3 bg-white">
      <button
